...
pub fn new_instance() -> i32 {
    ...
    extern "C" fn on_context_scoped() {
        ...
        modules.Set(
            v8::String::NewFromUtf8("datagram"),
            builtin::datagram::Init(),
        );
        ...
        modules.Set(
            v8::String::NewFromUtf8("querystring"),
            builtin::path::Init(),
        );
        modules.Set(
            v8::String::NewFromUtf8("readline"),
            builtin::readline::Init(),
        );
...

        {
            ...
            global.Set(
                v8::String::NewFromUtf8("process"),
                modules.Get(v8::String::NewFromUtf8("process")),
            );
            global.Set(
                v8::String::NewFromUtf8("console"),
